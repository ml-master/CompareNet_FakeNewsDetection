...
def parse_arguments():
    ...
    parser.add_argument("--train", type=str, default='./data/gossipcop_v3_origin.json')
    ...
    parser.add_argument("--model_file", type=str, default='model_CompareNet_Max_DET_0620_1944.t7',
...
def main(params = None):
    ...
    # params.ntags = 2
    # params.mode = 1
    params.model_file = 'model_CompareNet_Max_DET_0620_1810.t7'
    params.train = './data/fakeNews/fulltrain.csv'
